                                            ...
                                            {contacts.map(contact => (
                                                ...
                                                <tr key={contact.id} className="border-b bg-white-100 hover:bg-neutral-100 dark:border-neutral-500 dark:bg-neutral-700">
                                                    ...
                                                    <td className="whitespace-nowrap px-6 py-4 inline-flex">
                                                        ...
                                                        <AlertDeletar handle={handleDelete} contatoid={contact.id}></AlertDeletar>
                                                        <ModalAssunto handleLigar={handleIniciarLigação} handleDesligar={handleEncerrarLigação} verificaLigação={verificaContatoEmLigação} chamada={chamadaEmAndamento} setChamada={setChamadaEmAndamento} dadosChamada={chamada} contact={contact}></ModalAssunto>
                                                    </td>
                                                </tr>
                                            ))}
